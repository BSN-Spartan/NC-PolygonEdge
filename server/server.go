...
func NewServer(config *Config) (*Server, error) {
...

	{
		...
		m.executor.SetGetWhitelistOption(func(header *types.Header) []types.Address {
			return m.consensus.WhiteList(header)
		})
	}
...
// GetWhitelistOption get the consensus white list option
func (b *jsonRPCHub) GetWhitelistOption() state.GetWhitelistOption {
	return func(header *types.Header) []types.Address {
		return b.Consensus.WhiteList(header)
	}

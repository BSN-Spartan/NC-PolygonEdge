...
const (
	CandidateType_consensus    CandidateType = 0
	CandidateType_whiteAccount CandidateType = 1
)
...
func (CandidateType) Descriptor() protoreflect.EnumDescriptor {
	return file_consensus_ibft_proto_ibft_operator_proto_enumTypes[0].Descriptor()
}

func (CandidateType) Type() protoreflect.EnumType {
	return &file_consensus_ibft_proto_ibft_operator_proto_enumTypes[0]
}
...
type Snapshot struct {
	...
	WhiteValidators []*Snapshot_Validator `protobuf:"bytes,5,rep,name=whiteValidators,proto3" json:"whiteValidators,omitempty"`
	WhiteVotes      []*Snapshot_Vote      `protobuf:"bytes,6,rep,name=whiteVotes,proto3" json:"whiteVotes,omitempty"`
}
...
func (x *Snapshot) GetWhiteValidators() []*Snapshot_Validator {
	if x != nil {
		return x.WhiteValidators
	}
	return nil
}

func (x *Snapshot) GetWhiteVotes() []*Snapshot_Vote {
	if x != nil {
		return x.WhiteVotes
	}
	return nil
...
type CandidatesResp struct {
	...
	WhiteCandidates []*Candidate `protobuf:"bytes,2,rep,name=whiteCandidates,proto3" json:"whiteCandidates,omitempty"`
}
...
func (x *CandidatesResp) GetWhiteCandidates() []*Candidate {
	if x != nil {
		return x.WhiteCandidates
	}
	return nil
}
...
type Candidate struct {
	...
	Address string        `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	Auth    bool          `protobuf:"varint,2,opt,name=auth,proto3" json:"auth,omitempty"`
	Mode    CandidateType `protobuf:"varint,3,opt,name=mode,proto3,enum=v1.CandidateType" json:"mode,omitempty"`
}
...
func (x *Candidate) GetMode() CandidateType {
	if x != nil {
		return x.Mode
	}
	return CandidateType_consensus
}
...
var file_consensus_ibft_proto_ibft_operator_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x89,
	0x03, 0x0a, 0x08, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x36, 0x0a, 0x0a, 0x76,
	...
	,
...
var file_consensus_ibft_proto_ibft_operator_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_consensus_ibft_proto_ibft_operator_proto_goTypes = []interface{}{
	(CandidateType)(0),         // 0: v1.CandidateType
	(*IbftStatusResp)(nil),     // 1: v1.IbftStatusResp
	(*SnapshotReq)(nil),        // 2: v1.SnapshotReq
	(*Snapshot)(nil),           // 3: v1.Snapshot
	(*ProposeReq)(nil),         // 4: v1.ProposeReq
	(*CandidatesResp)(nil),     // 5: v1.CandidatesResp
	(*Candidate)(nil),          // 6: v1.Candidate
	(*Snapshot_Validator)(nil), // 7: v1.Snapshot.Validator
	(*Snapshot_Vote)(nil),      // 8: v1.Snapshot.Vote
	(*empty.Empty)(nil),        // 9: google.protobuf.Empty
}
var file_consensus_ibft_proto_ibft_operator_proto_depIdxs = []int32{
	7,  // 0: v1.Snapshot.validators:type_name -> v1.Snapshot.Validator
	8,  // 1: v1.Snapshot.votes:type_name -> v1.Snapshot.Vote
	7,  // 2: v1.Snapshot.whiteValidators:type_name -> v1.Snapshot.Validator
	8,  // 3: v1.Snapshot.whiteVotes:type_name -> v1.Snapshot.Vote
	6,  // 4: v1.CandidatesResp.candidates:type_name -> v1.Candidate
	6,  // 5: v1.CandidatesResp.whiteCandidates:type_name -> v1.Candidate
	0,  // 6: v1.Candidate.mode:type_name -> v1.CandidateType
	2,  // 7: v1.IbftOperator.GetSnapshot:input_type -> v1.SnapshotReq
	6,  // 8: v1.IbftOperator.Propose:input_type -> v1.Candidate
	9,  // 9: v1.IbftOperator.Candidates:input_type -> google.protobuf.Empty
	9,  // 10: v1.IbftOperator.Status:input_type -> google.protobuf.Empty
	3,  // 11: v1.IbftOperator.GetSnapshot:output_type -> v1.Snapshot
	9,  // 12: v1.IbftOperator.Propose:output_type -> google.protobuf.Empty
	5,  // 13: v1.IbftOperator.Candidates:output_type -> v1.CandidatesResp
	1,  // 14: v1.IbftOperator.Status:output_type -> v1.IbftStatusResp
...
func file_consensus_ibft_proto_ibft_operator_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_consensus_ibft_proto_ibft_operator_proto_enumTypes,
